...
function calculateBMI() {
    ...
    let resultText;
    if (mass < 16) {
        resultText = `Your BMI is ${mass.toFixed(2)}, and you have <strong>Severe Thinness</strong>.`;
    } else if (mass >= 16 && mass <= 16.9) {
        resultText = `Your BMI is ${mass.toFixed(2)}, and you have <strong>Moderate Thinness</strong>.`;
    } else if (mass >= 17 && mass <= 18.4) {
        resultText = `Your BMI is ${mass.toFixed(2)}, and you have <strong>Mild Thinness</strong>.`;
